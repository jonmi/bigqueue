...
public class SingleThreadSortAndSearch {
    ...
    static void mergeSort() throws IOException {
        ...
        final Queue<IBigQueue> queueOfSortedQueues = new LinkedList<IBigQueue>();
        ...
        final IBigArray bigArray = new BigArrayImpl(MergeSortHelper.SAMPLE_DIR, "sample_array");
    ...
    static void binarySearch() throws IOException {
        ...
        final int searchLoopLimit = 10000;
        final List<String> randomKeys = new ArrayList<String>();
        final Random random = new Random();
        for (int i = 0; i < searchLoopLimit / 2; i++) {
            final long randomIndex = (long) (random.nextDouble() * maxNumOfItems);
            final String randomKey = new String(bigArray.get(randomIndex));
        ...
        for (int i = 0; i < searchLoopLimit; i++) {
            ...
            final long result = BinarySearchHelper.binarySearch(bigArray, randomKey, 0, bigArray.size() - 1);
